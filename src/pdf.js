...
function createPreRetirementSummaryCanvases({ retirement, currency, language, t, isFree, colors }) {
  ...
  const columns = [
    [t.age, 50, "left"],
    [t.openingBalance, 110, "right"],
    [t.monthlySavings, 95, "right"],
    [t.annualSavings, 100, "right"],
    [t.annualRetirementContribution, 120, "right"],
    [t.totalReturn, 95, "right"],
    [t.oneTimeMoneyEvents, 105, "right"],
    [t.cashBalance, 105, "right"],
    [t.investmentBalance, 115, "right"],
    [t.retirementBalance, 115, "right"],
    [t.accessibleBalance, 110, "right"],
    [t.lockedBalance, 110, "right"],
    [t.projectedBalance, 115, "right"],
    [t.targetBalance, 115, "right"],
    [t.fundingGap, 93, "right"],
  ];
  const tableX = 46;
  const headerY = 310;
  const headerH = 86;
  ...
  chunks.forEach((chunk, pageIndex) => {
    ...
    chunk.forEach((row, rowIndex) => {
      ...
      const values = [
        ...
        amount(row.cashBalance, currency, true),
        amount(row.investmentBalance, currency, true),
        amount(row.retirementBalance, currency, true),
...
function createYearlySummaryCanvases({ retirement, currency, language, t, isFree, colors, startPage = 2 }) {
  ...
  const columns = [
    [t.age, 45, "left"],
    [t.openingBalance, 90, "right"],
    [t.monthlySpending, 90, "right"],
    [t.yearlySpending, 95, "right"],
    [t.inflation, 65, "right"],
    [t.cashReturn, 85, "right"],
    [t.investmentReturn, 95, "right"],
    [t.retirementReturn, 95, "right"],
    [t.otherMonthlyIncome, 90, "right"],
    [t.otherYearlyIncome, 95, "right"],
    [t.totalReturn, 85, "right"],
    [t.oneTimeMoneyEvents, 90, "right"],
    [t.cashBalance, 95, "right"],
    [t.investmentBalance, 105, "right"],
    [t.retirementBalance, 105, "right"],
    [t.endingBalance, 105, "right"],
  ];
  const tableX = 46;
  const headerY = 332;
  const headerH = 82;
